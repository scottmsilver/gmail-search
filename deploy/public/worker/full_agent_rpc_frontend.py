#!/usr/bin/env python3
"""Unprivileged forced-SSH frontend: one bounded full-agent request to one fixed socket.

Installed root-owned alongside full_agent_rpc.py. No arguments, shell commands,
