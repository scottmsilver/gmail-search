...
Return a concise answer with thread IDs, dates and short supporting excerpts or amounts for each claim. Separate facts from inference and name any gap. Do not delegate further or publish artifacts.
