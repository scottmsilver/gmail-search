...
from firecracker_backend import SyntheticFullAgentBackend,ROOT,JAILS,boundary
...
def main():
    ...
    try:
        ...
        while time.monotonic()<deadline:
            ...
            if 'GMS_AGENT_RUNNER_COMPLETE' in content.splitlines():break
            if 'GMS_AGENT_RUNNER_FAILED' in content.splitlines() or handle not in backend.inventory():
                print('\n'.join(line for line in content.splitlines() if line.startswith('GMS_AGENT_RUNNER')),flush=True)
